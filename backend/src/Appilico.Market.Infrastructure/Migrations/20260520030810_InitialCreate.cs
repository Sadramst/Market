        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ProviderCount = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetNote = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    H1 = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    Content = table.Column<string>(type: "text", nullable: true),
                    SchemaJson = table.Column<string>(type: "text", nullable: true),
                    MarketplaceType = table.Column<int>(type: "integer", nullable: false),
                    IsPublished = table.Column<bool>(type: "boolean", nullable: false),
                    ProviderCount = table.Column<int>(type: "integer", nullable: false),
                    SuburbId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeoPages_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SeoPages_Suburbs_SuburbId",
                        column: x => x.SuburbId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Follows_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProviderGalleryImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProviderGalleryImages_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    ProviderId = table.Column<Guid>(type: "uuid", nullable: false),
                    SuburbId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProviderServiceAreas_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProviderServiceAreas_Suburbs_SuburbId",
                        column: x => x.SuburbId,
                        principalTable: "Suburbs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    PriceFrom = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    PriceTo = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    PriceNote = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceOffers_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_MarketplaceType",
                table: "Categories",
                column: "MarketplaceType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Conversations_ProviderId_CustomerId",
                table: "Conversations",
                columns: new[] { "ProviderId", "CustomerId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_UserId_ProviderId",
                table: "Favorites",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Follows_UserId_ProviderId",
                table: "Follows",
                columns: new[] { "UserId", "ProviderId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProviderServiceAreas_ProviderId_SuburbId",
                table: "ProviderServiceAreas",
                columns: new[] { "ProviderId", "SuburbId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProviderServiceAreas_SuburbId",
                table: "ProviderServiceAreas",
                column: "SuburbId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeoPages_CategoryId",
                table: "SeoPages",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SeoPages_MarketplaceType",
                table: "SeoPages",
                column: "MarketplaceType");

            migrationBuilder.CreateIndex(
                name: "IX_SeoPages_PageType",
                table: "SeoPages",
                column: "PageType");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceOffers_ServiceRequestId_ProviderId",
                table: "ServiceOffers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Suburbs_PostCode",
                table: "Suburbs",
                column: "PostCode");

            migrationBuilder.CreateIndex(
                name: "IX_Suburbs_Slug",
                table: "Suburbs",
                column: "Slug",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Suburbs_State",
                table: "Suburbs",
                column: "State");
        }
