export const BEAUTY_CATEGORIES = [
  ...
  { slug: "body", name: "Body", icon: "🌸", description: "Remedial massage, waxing, spray tan, body wraps and tanning", displayName: "Body & Massage Therapists", gradient: "from-pink-50 to-fuchsia-100", accent: "#C8737A" },
